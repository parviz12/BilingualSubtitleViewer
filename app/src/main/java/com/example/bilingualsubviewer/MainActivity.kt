...
class MainActivity : AppCompatActivity() {
    ...
    private fun scrollToSubtitleIfPossible() { if (currentPosition in subtitles.indices) subtitleList.post { scrollToSubtitle(subtitles[currentPosition]) } }
    ...
    private fun loadMedia(uri:Uri){try{
        ...
        fileNameText.text=uri.lastPathSegment?:getString(R.string.media_file); videoHidden=false; playerView.visibility=View.VISIBLE;playerView.alpha=1f;playerView.requestLayout();playerControls.visibility=View.VISIBLE
        videoToggleButton.visibility=View.VISIBLE;speedButton.visibility=View.VISIBLE;loopButton.visibility=View.VISIBLE;videoToggleButton.text=getString(R.string.hide_video);updatePlaybackControls()
